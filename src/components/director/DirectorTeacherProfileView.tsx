...
import { ResumenConstanciasCard } from "@/components/docente/ResumenConstanciasCard";
import { obtenerPerfilDocentePorCodigo } from "@/services/director/directorService";
